...
Per the instructions in the assignment email, two of the four parts were selected:

- **Part 1 — Pricing Model** (`part1_pricing/`)
- **Part 4 — System Design** (`part4_system_design/`)

## Repository structure

```
part1_pricing/          get_quote / get_bid_ask implementation and test output
part4_system_design/    failure mode matrix, kill switch design, gas top-up pseudocode
README.md
```
...
- **A9:** Fees are accounted for separately from pricing reserves. This is a stateless
  ...
  while 15,000 + 5,000 returns 30.669075 WBNB. Case A split into 2 x 250 USDT yields about
  6.14e-5 WBNB less than a single 500 USDT trade. This is covered by a regression test.
...
See [results.md](part1_pricing/results.md) for the generated A-D tables, the 5 bps
...
[test_pricing.py](part1_pricing/test_pricing.py) checks the official numerical
...
To regenerate the example output as UTF-8:
...
See `part4_system_design/DESIGN.md`.
